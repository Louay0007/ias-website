			...
			<div className="w-[82%] sm:w-full xm:w-full padding-x mb-[70px]">
				<h1 className="sub-heading font-medium font-NeueMontreal text-secondry">
					<span className="xl:link-flash lg:link-flash md:link-flash cursor-pointer">
					 ...
					 In today’s fast-paced world, there’s no excuse for not staying ahead in the industrial applications field. The opportunities are endless, and the industry is evolving rapidly. Focus on what you do best—growing your knowledge and skills—while we do our best at providing you with the tools, resources, and networks to help you thrive. With IEEE IAS ISSATM, you’ll gain hands-on experience, access to global events, and professional connections that will set you apart in the world of industrial applications.
