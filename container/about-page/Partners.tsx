	...
	return (
		<section className="w-full bg-background">
			<div>
				...
				The IEEE IAS Student Chapter connects students to the global IEEE Industrial Applications Society, offering resources and networking opportunities. It enables engagement with technical communities and industry leaders.
				</h1>
			</div>
