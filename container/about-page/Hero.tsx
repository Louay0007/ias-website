	...
	return (
		<section className="w-full min-h-screen">
							...
							<div className="w-[48%] flex justify-between sm:w-full xm:w-full sm:flex-col xm:flex-col gap-[20px]">
								<div className="w-[50%] flex flex-col gap-y-[40px] sm:w-full xm:w-full">
									<div className="flex flex-col gap-y-[20px]">
										...
										The IEEE IAS ISSATM SB Chapter has consistently demonstrated remarkable contributions to the field, participating in a wide array of prestigious events at both local and international levels. Our members have actively engaged in congresses, conferences, competitions, and collaborative initiatives, showcasing their exceptional talents and representing the chapter with outstanding excellence.
										</p>
									</div>
									<div className="flex flex-col gap-y-[20px]">
										<p className="paragraph font-NeueMontreal text-secondry">
										Through these experiences, the chapter ensures that its members develop a well-rounded skill set, equipping them to meet the challenges and demands of both the present and the future. This commitment to professional growth and development helps foster a community of leaders ready to make a significant impact in the world of engineering and beyond.
										</p>
									</div>
								</div>
			...
			<div className="padding-x">
				...
				We empower the industry with innovative solutions and skilled leaders, transforming challenges into impactful successes.
